...
example = 'table';
%example = 'car';
% img_name1 = '../video/74_color.png';
% img_name2 = '../video/75_color.png';
img_name1 = '../box/box1_1080.png';
img_name2 = '../box/box2_1080.png';
% load the two frames
im1 = im2double(imread(img_name1));
im2 = im2double(imread(img_name2));
